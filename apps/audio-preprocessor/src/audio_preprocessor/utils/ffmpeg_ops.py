...
def process_audio(input_path: str, output_path: str):
    """
    Chuỗi xử lý audio mạnh mẽ:
    1. Highpass Filter: Loại bỏ tiếng ồn trầm < 80Hz (tiếng gió, tiếng xe).
    2. Lowpass Filter: Loại bỏ tiếng rít > 8000Hz (giọng người thường không vượt quá mức này).
    3. Loudnorm: Chuẩn hóa âm lượng (tránh file quá bé hoặc quá to).
    4. Resample: 16kHz, Mono.
    """
    try:
